    ...
    */
    ...
    protected function _check_dependencies()
    {
        if (!function_exists('WC')) {
            throw new Exception(__('WaafiPay plugin for WooCommerce requires WooCommerce to be activated', 'waafi-woocommerce'), self::DEPENDENCIES_UNSATISFIED);
        }

        if (version_compare(WC()->version, '3.0', '<')) {
            throw new Exception(__('WaafiPay plugin for WooCommerce requires WooCommerce version 3.0 or greater', 'waafi-woocommerce'), self::DEPENDENCIES_UNSATISFIED);
        }

        if (!function_exists('curl_init')) {
            throw new Exception(__('WaafiPay plugin for WooCommerce requires cURL to be installed on your server', 'waafi-woocommerce'), self::DEPENDENCIES_UNSATISFIED);
        }
    }
